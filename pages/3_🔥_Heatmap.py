...
with st.expander("See summary details"):
    ...
    st.markdown('- Only 1 project has a duration under 3 months which appears to be related to the Peach Bottom relicensing in 2004 for which there are no cost data.')
...
with st.expander("See technical notes"):
    ...
    st.markdown('- Cleaned interconnection cost datasets for "active", "withdrawn", and "completed" projects.')
    st.markdown('- Study Type: interconnection study type (Feasibility Study, System Integration Study, Addendum).')
